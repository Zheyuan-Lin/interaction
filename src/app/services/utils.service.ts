...
export class UtilsService {
  // Global constants (using AppConstants for consistency)
  static readonly GROUP_NAME = AppConstants.GROUP_NAME;
  ...
  validateAndStandardizeMessage(message) {
    ...
    // Ensure group
    if (!message.group) message.group = UtilsService.GROUP_NAME;
